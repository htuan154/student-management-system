...
namespace StudentManagementSystem.Data.Interfaces
{
    public interface IClassRepository : IRepository<Class>
    {
        ...
        Task<Class?> GetClassWithFullDetailsAsync(string classId);
        ...
        Task<(IEnumerable<Class> Classes, int TotalCount)> GetPagedClassesAsync(
        ...
        Task<IEnumerable<Class>> GetClassesBySemesterIdAsync(int semesterId);
        Task<IEnumerable<Class>> GetActiveClassesBySemesterIdAsync(int semesterId);
        Task<int> GetClassCountBySemesterAsync(int semesterId);
        Task<int> GetActiveClassCountBySemesterAsync(int semesterId);
    }
}
